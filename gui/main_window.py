...
class TypingSpeedTestApp:
    ...
    def __init__(self):
        ...
        self.main_frame = ttk.Frame(self.window, style="Card.TFrame", padding=20)
        ...
        footer_frame = ttk.Frame(self.main_frame, style="Card.TFrame")
        footer_frame.pack(fill="x", pady=(0, 10))

        self.timer_label = ttk.Label(footer_frame, text="Time: 0s", style="Timer.TLabel")
        self.timer_label.pack(side="left")

        self.info_label = ttk.Label(
            footer_frame,
            text="Ο χρόνος θα ξεκινήσει με κλικ στο πεδίο κειμένου.",
            style="Body.TLabel"
        )
        self.info_label.pack(side="right")

        entry_container = tk.Frame(self.main_frame, bg="#eef2f6", padx=6, pady=6)
